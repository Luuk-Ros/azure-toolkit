...
.DESCRIPTION
    ...
    Excludes Windows 10, Windows 11, and Azure Virtual Desktop images.

.PARAMETER TenantId
    The Azure Active Directory tenant ID to authenticate against.

.PARAMETER SubscriptionId
    The subscription ID containing the VMs to scan.

.EXAMPLE
    .\Get-WsusRolesPerVm.ps1
    Scans all running Windows Server VMs in the configured subscription.
